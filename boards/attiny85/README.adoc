...
The compact protoboard omits the AVR adapter, puts a 2.1mm barrel jack on the board, incorporates a socket to ensconce the ATtiny85, and adds a DC/DC converter along with an electrolytic capacitor to convert 12V power down to 5V for the ATtiny85.
