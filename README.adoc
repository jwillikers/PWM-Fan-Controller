...
++++
<p align="center">
  <img  alt="ATTiny85 PWM Fan Controller Protoboard Top View" src="attiny85/pics/attiny85-pwm-fan-controller-top.jpg?raw=true"/>
</p>
++++
endif::[]

ifndef::env-github[]
image::attiny85/pics/attiny85-pwm-fan-controller-top.jpg[ATTiny85 PWM Fan Controller Protoboard Top View, align=center]
endif::[]
